from N1_Call_API import get_steam_details, get_steam_review_score, get_steam_all_reviews ; from N2_Insert_BDD import insert_games_in_database, insert_game_review_score ;
